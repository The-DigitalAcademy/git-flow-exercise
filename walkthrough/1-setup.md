...
In order to contribute to a GitHub project, you will need two things: a Github Project and a local clone of this project.
...
Fork the source repository:
   1. Visit https://github.com/The-DigitalAcademy/git-flow-exercise
...
* remote me
  ...
  Remote branches:
    ...
    main  new (next fetch will store in remotes/me)
  Local ref configured for 'git push':
    main  pushes to main (up to date)
```
